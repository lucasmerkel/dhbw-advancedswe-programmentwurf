...
\todo[]{Test first und TDD erwähnen?}
...
\todo[]{Code Coverage (mindestens 1, mehr gibt Bonus) der gesammten Schichten}
\todo[]{Über alle Unit-Tests, Line und Branch Coverage}

...
Die Klasse hat die einzige Aufgabe, Objekte der Klasse \href{}{\code{}}\textit{ConsumerGoods} zu Objekten der Klasse \href{}{\code{}}\code{ConsumerGoodsResource} zu mappen und somit für die Interaktion mit der \ac{GUI} zu verwenden.
Das gleiche gilt für die Klasse \href{}{\code{}}\code{FridgeToFridgeResourceMapper} und \href{}{\code{}}\code{FoodShelfToFoodShelfResourceMapper}, deren Aufgabe das Mappen eines \href{}{\code{}}\code{Fridge}- oder \href{}{\code{}}\code{FoodShelf}-Objekt zu einer entsprechenden Resource ist.

Das \textit{Single Responsibility Principle}-Prinzip wurde hingegen bei den Klassen \href{}{\code{}}\code{ConsumerGoodsManager} sowie \href{}{\code{}}\code{StorageManager} verletzt. Die Klassen haben neben dem Suchen eines Objekts auch die Aufgabe der Erstellung sowie das Löschen eines Objekts.
In diesem Zusammenhang lässt sich ebenfalls eine Verletzung des \textit{Single Responsibility Principle}-Prinzip bei der Klasse \href{}{\code{}}\code{ConsumerGoodsGuiController} erkennen.
Die Interaktion mit der \ac{GUI} umfasst sowohl das Erstellen, als auch das Ausgeben der verfügbaren Objekte der Klasse \href{}{\code{}}\code{ConsumerGoods}.
Gleiches gilt für das Löschen eines Objektes.
Hierzu findet die gesamte Interaktion, die verschiedene Aufgaben enthält, in der Klasse \href{}{\code{}}\code{ConsumerGoodsGuiController} statt.
Die Verletzung des \textit{Single Responsibility Principle}-Prinzip trifft auch auf die Klasse \href{}{\code{}}\code{StorageGuiInterface} zu.
Auch hier findet die gesamte Interaktion mit der Schnittstelle, worunter das Ausgeben, Erstellen und Löschen von Objekten des implementierten Interfaces \href{}{\code{}}\code{Storage} zählt, in der einen Klasse statt.

\todo[]{erklären, warum das eingehalten und warum es verletzt wurde}
\todo[]{eingehalten, weil }
\todo[]{verletzt, weil }

\subsubsection*{Open-Closed-Principle}
Das \textit{Open-Closed-Principle} wurde bei den Klassen \href{}{\code{}}\code{ConsumerGoodsResource}, \href{}{\code{}}\textit{FridgeResource} und \href{}{\code{}}\textit{FoodShelfResource} sowie bei den weiteren Resourcen-Klassen eingehalten.
...
Eine Verletzung des \textit{Open-Closed-Principle} stellen die Klassen \href{}{\code{}}\code{ConsumerGoodsGuiInterface} und \href{}{\code{}}\code{StorageGuiInterface} dar.
...
Es ist eine Vererbung der Superklasse \href{}{\code{}}\code{UnitOfMeasure} und den Subklassen \href{}{\code{}}\code{Volume}, \href{}{\code{}}\code{Weight} und \href{}{\code{}}\code{Quantity} implementiert.
Bei \href{}{\code{}}\code{UnitOfMeasure} handelt es sich um eine abstrakte Klasse.
...
Das Gleiche gilt für die Implementierung der Vererbung der Superklasse \href{}{\code{}}\code{Storage} und den Subklassen \href{}{\code{}}\code{Fridge} und \href{}{\code{}}\code{FoodShelf}.
Auch in diesem Fall ist die Klasse \href{}{\code{}}\code{Storage} abstrakt und die Subklassen überschreiben keine Funktionalität der Superklasse, wodurch das \textit{Liskov Substitution Principle} eingehalten wird.
...
Ein Positivbeispiel der Umsetzung des \textit{Interface Segregation Principle} zeigt sich in den Interfaces \href{}{\code{}}\code{FridgeRepository} und \href{}{\code{}}\code{FoodShelfRepositoy}.
...
Diesen Negativpunkt betrifft ebenfalls das Interface \href{}{\code{}}\code{ConsumerGoodsRepository}.
...
Das \textit{Dependency Inversion Principle} wurde bei den Klassen \href{}{\code{}}\code{ConsumerGoods} sowie \href{}{\code{}}\code{Food} umgesetzt.
%und dem Interface \href{}{\code{}}\code{StorableGood} umgesetzt.
Die Klasse \href{}{\code{}}\code{ConsumerGoods} referenziert dabei auf ein Objekt des Typs \href{}{\code{}}\code{StorableGood}. 
Das hat zur Folge, dass unter Anwendung der Dependency Injection eine Erweiterung weiterer lagerbarer Objekte neben Essen möglich ist, ohne die Klasse \href{}{\code{}}\code{ConsumerGoods} hierzu anpassen zu müssen.Die Klasse \href{}{\code{}}\code{ConsumerGoods} referenziert dabei auf ein Objekt des Typs \href{}{\code{}}\code{StorableGood}.
...
Darüber hinaus sind die Interfaces \href{}{\code{}}\code{ConsumerGoodsRepository}, \href{}{\code{}}\code{FridgeRepository} und \href{}{\code{}}\code{FoodShelfRepository} ein weiteres positives Beispiel.
Die Interfaces definieren alle nötigen Methoden und die Services \href{}{\code{}}\code{ConsumerGoodsManager} und \href{}{\code{}}\code{StorageManager} haben zur Laufzeit eine Abhängigkeit auf ein Objekt, welches das entsprechende Interface implementiert hat.
...
Die Interaktion findet über die Klasse \href{}{\code{}}\code{ConsumerGoodsGuiInterface} und \href{}{\code{}}\code{StorageGuiInterface} statt.
...
Eine geringe Kopplung wurde bei der Implementierung ebenfalls erzielt, indem die Repository-Klassen \href{}{\code{}}\code{ConsumerGoodsRepository}, \href{}{\code{}}\code{FridgeRepository} und \href{}{\code{}}\code{FoodShelfRepositoy} bei der Rückgabe der instanziierten Objekte diese nicht als Liste vom Typ \textit{List} zurückgeben sondern als \textit{Iterable}.
...
Eine stärkere Kopplung ist in den Serviceklassen \href{}{\code{}}\code{ConsumerGoodsManager} und \href{}{\code{}}\code{StorageManager} zu finden.
Zum Löschen, Persistieren oder der Rückgabe initialisierter Objekte der Klassen \href{}{\code{}}\code{ConsumerGoods}, \href{}{\code{}}\code{Fridge} oder \href{}{\code{}}\code{FoodShelf} werden ausschließlich die in den entsprechenden Repository-Interfaces definierten Klassen verwendet.
...
Ein Beispiel mit einer starken Kopplung ist der statische Methodenaufruf \href{}{\code{}}\code{validate()} der Klasse \code{DateValidator}.
Auch in diesem Fall entsteht durch den statischen Methodenaufruf eine starke Kopplung an die Klasse \href{}{\code{}}\code{DateValidator}.
\todo[]{gemacht, weil}

\subsubsection*{Hohe Kohäsion}
Ein Beispiel für eine hohe Kohäsion ist in der Klasse \href{}{\code{}}\code{ConsumerGoods} zu sehen.
Die Bestandteile eines Konsumguts sind das Lebensmittel und die dazugehörige Menge samt Maßeinheit.
Das Lebensmittel wird dazu in der Klasse \href{}{\code{}}\code{Food} verwaltet, während die Menge in einem Objekt des implementierten Interface-Typs \href{}{\code{}}\code{UnitOfMeasure} verwaltet ist.
Die Klasse \href{}{\code{}}\code{Food} hat als Attribut eine Instanz der Klasse \href{}{\code{}}\code{BestBeforeDate} zur Repräsentation des Mindesthaltbarkeitsdatums.
In der Klasse \href{}{\code{}}\code{BestBeforeDate} werden auch datumsspezifische Operationen wie zum Beispiel die Datumsüberprüfung mithilfe des \href{}{\code{}}\code{DateValidators} übernommen.
Das Objekt des implementierten Interfaces-Typs \href{}{\code{}}\code{UnitOfMeasure} repräsentiert die Menge in Form der Klassen \href{}{\code{}}\code{Weight}, \href{}{\code{}}\code{Volume} oder \href{}{\code{}}\code{Quantity}.
Der Wert der Menge wird in den Klassen durch das Attribut vom Typ \href{}{\code{}}\code{Value} verwaltet.
Das Ziel ist hierdurch, dass die jeweiligen Bestandteile des \href{}{\code{}}\code{ConsumerGoods} in einzelnen Klassen verwaltet werden, dadurch teilt sich der Code auf die entsprechenden Schwerpunkte auf und wird, gerade in Bezug auf Übergabe- und Rückgabeparameter, lesbarer.

Ein weiteres Beispiel für hohe Kohäsion ist die Klasse \href{}{\code{}}\code{BestBeforeDate}.
Das Mindesthaltbarkeitsdatum wird durch die Variablen des Typs \href{}{\code{}}\code{DateOfYear} und \href{}{\code{}}\code{Year} repräsentiert.
\href{}{\code{}}\code{DateOfYear} verwaltet das Datum eines Jahres durch die Attribute vom Typ \code{Day} und \code{Month}.
...
Darüber hinaus ist nicht die Klasse \href{}{\code{}}\code{BestBeforeDate} für eine genaue Spezifizierung oder Anpassung der einzelnen Attribute verantwortlich sondern die jeweiligen spezifischen Klassen.

\subsection{\ac{DRY}}
\todo[]{Positivbeispiel}

Eine Nichteinhaltung des \ac{DRY}-Prinzip findet sich in der Resourcen-Klassen \href{}{\code{}}\code{ConsumerGoodsReource}, \href{}{\code{}}\code{FridgeResource}, \href{}{\code{}}\code{FoodShelfResource}, \href{}{\code{}}\code{FoodResource} und \href{}{\code{}}\code{BestBeforeDateResource} vor.

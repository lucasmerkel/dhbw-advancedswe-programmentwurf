...
Die Entscheidung für die Repräsentation eines Tages des Jahres durch die Klasse \href{}{\code{DateOfYear}} ist, dass das MHD oftmals innerhalb eines Jahres liegt und bei der Validierung des Datums nur im Monat Februar das Jahr relevant ist.
...
Daneben haben Konsumgüter eine Menge, die durch die Assoziation auf die Klasse vom Typ \href{}{\code{UnitOfMeasure}} repräsentiert wird.
Als konkrete Maßeinheit können Gewicht, Volumen oder Stückzahl gewählt werden und werden durch die gleichnamigen Klassen \href{}{\code{Weight}}, \href{}{\code{Volume}} und \href{}{\code{Quantity}} repräsentiert.
...
Die Interfaces \href{}{\code{ConsumerGoodsRepository}}, \href{}{\code{FridgeRepository}} sowie \href{}{\code{FoodShelfRepository}} dienen zur Implementierung von, ebenfalls in \ac{DDD} definierten, Repositories in Bezug auf die Klassen \href{}{\code{ConsumerGoods}}, \href{}{\code{Fridge}} und \href{}{\code{FoodShelf}}.
...
Die Klassen \href{}{\code{Day}}, \href{}{\code{Month}} und \href{}{\code{Year}} dienen dabei dem Speichern des gleichnamigen Teils des Datums.
Die Klasse \href{}{\code{Value}} speichert den Wert der dazugehörigen Einheit innerhalb der Klassen \href{}{\code{Volume}}, \href{}{\code{Quantity}} oder \href{}{\code{Weight}}.
...
Eines stellt die Klasse \href{}{\code{DayOfYear}} dar.
Die Klasse dient der Verwaltung der \textit{Value Objects} \href{}{\code{Day}} sowie \href{}{\code{Month}} und repräsentiert somit den Tag eines Jahres.
Auch in diesem Fall zeichnet sich die Klasse \href{}{\code{DayOfYear}} als \textit{Value Object} aus, da es den reinen und unveränderlichen Werten eine Semantik in der Domäne gibt und keine Identität oder Lebenszyklus aufweist.
...
Die Klasse \href{}{\code{ConsumerGoods}} repräsentiert einen Gegenstand der Domäne, ein Konsumgut.
Die Klassen \href{}{\code{Fridge}} und \href{}{\code{FoodShelf}} repräsentieren ebenfalls Gegenstände der Domäne, nämlich einen Kühlschrank und ein Lebensmittelregal.
...
Dementsprechend hat hat die Klasse \href{}{\code{ConsumerGoods}} den natürlichen Schlüssel \href{}{\code{EAN}} zur eindeutigen Identifikation implementiert.
...
Bei der \textit{Entity} \href{}{\code{Fridge}} ist jedoch kein eindeutiger Schlüssel in der Domäne enthalten, weshalb ein Surrogatschlüssel angewandt wird.
Die Klasse \href{}{\code{Fridge}} hat hierzu eine Variable \href{}{\code{id}}, deren Wert automatisch systemseitig zur Laufzeit generiert wird.
Der Vorteil ist, dass der Schlüssel jederzeit generierbar ist, jedoch keinen Bezug zur Domäne hat.
Bei der \textit{Entity} \href{}{\code{FoodShelf}} ist ebenfalls kein eindeutiger Schlüssel in der Domäne enthalten, weshalb auch ein Surrogatschlüssel angewandt wird.
Die Generierung läuft entsprechend gleich zu der in der Klasse \href{}{\code{Fridge}} ab.
...
Bei Analyse des größten \textit{Aggregates} innerhalb des Softwareentwurfs ist zu erkennen, dass neben der \textit{Entity} \href{}{\code{ConsumerGoods}} auch eine Implementierung des Interfaces \href{}{\code{StorableGoods}}, was in dem aktuellen Stand nur auf die Klasse \href{}{\code{Food}} zutrifft, zu diesem \textit{Aggregate} zählen. 
...
Bei Betrachtung der Visualisierung des \textit{Aggregates} ist zu erkennen, dass ein Zugriff auf die Objekte innerhalb des \textit{Aggregates} über das Objekt der Klasse \href{}{\code{ConsumerGoods}} erfolgen.
Es handelt sich somit beim Objekt der Klasse \href{}{\code{ConsumerGoods}} um ein \textit{Aggregate Root}.
Direkte Referenzen auf Elemente innerhalb des \textit{Aggregates} sind dabei nicht erlaubt.
Eine Betrachtung des \href{}{\code{UML-Diagramms}} zeigt jedoch, dass solch eine direkte Referenz nicht vorliegt und der Zugriff ausschließlich über den \textit{Aggregate Root} funktioniert.
\todo[]{Aktuell durch Resource verletzt, entweder ändern und erläutern oder Verletzung erläutern}

Ein Objekt der Klasse \href{}{\code{ConsumerGoods}} kann somit den gesammten Zugriff auf das \textit{Aggregate} kontrollieren und die Einhaltung der Domänenregeln gewährleisten.
Ein Beispiel ist in diesem Fall die Validierung des eingegebenen Mindesthaltbarkeitsdatums durch die Klasse \href{}{\code{DateValidator}}.
...
Das \textit{Aggregate Root} \textit{ConsumerGoods} ist über die ID \href{}{\code{eanCode}} eindeutig identifizierbar.
Ein Verlust dieser ID zur Laufzeit führt dazu, dass neben dem Objekt der Klasse \href{}{\code{ConsumerGoods}} das gesammte \textit{Aggregate} und somit das dazugehörige Objekt der Klasse \href{}{\code{Food}}, \href{}{\code{BestBeforeDate}} als auch das Objekt der Spezialisierung der Superklasse \href{}{\code{UnitOfMeasure}} nicht mehr erreichbar.
...
Bei den \textit{Aggregates} \href{}{\code{Fridge}} und \href{}{\code{FoodShelf}} handelt es sich um Spezialisierungen der Superklasse \href{}{\code{Storage}}.
...
Die Bezeichnung der Methoden ist ebenfalls an die Domäne angepasst, wie anhand eines Beispiels an der Klasse \href{}{\code{ConsumerGoodsRepository}} zu sehen ist.
...
Die Implementierung von Repositories wurde gewählt, damit neben der Zusammenarbeit zwischen den \textit{Aggregates} \href{}{\code{ConsumerGoods}}, \href{}{\code{Fridge}} als auch \href{}{\code{FoodShelf}} sowohl ein \textit{Repository}-Modell vorhanden ist als auch zugleich eine zentrale Verwaltungsmöglichkeit.
